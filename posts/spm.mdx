...
<Latex>$$ \frac{\partial c_{s}}{\partial t} = \frac{D_s}{r^2}\frac{\partial}{\partial r}(r^2 \frac{\partial c_s}{\partial r}) $$</Latex>

where concentration <Latex>$$c_s$$</Latex> has units $$ [\frac{mol}{m^2}]$$  
